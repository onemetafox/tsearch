        ...
        datatable = $('#events').KTDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    if(row.image){
                        return '\
                            <img style="width:30px; height:30px" src="'+HOST_URL+'uploads/'+row.image+'" alt="image">\
                        ';
                    }else{
                        return "";
                    }
            ...
            , {
                ...
                template: function(row) {
                    return '\
                    <a href="'+HOST_URL+'admin/talent/edit/'+row.id+'" class="btn btn-icon btn-light btn-hover-primary btn-sm edit_btn" title = "編集">\
...
//     $.ajax({
//         type: "POST",
//         url: HOST_URL + "admin/talent/setType",
//         data: {"id" : id, "admin": "true" },
//         dataType: "json",
//         encode: true,
//     }).done(function (data) {
...
function onDel(id){
    $.ajax({
        type: "POST",
        url: HOST_URL + "admin/talent/delete",
        data: {"id" : id },
        dataType: "json",
        encode: true,
    }).done(function (data) {
