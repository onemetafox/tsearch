...
<html lang="en">
    ...
    <body id="kt_body" style="background-image: url(<?=asset_url()?>/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
        ...
        <div id="kt_header_mobile" class="header-mobile">
            <!--begin::Logo-->
            <a href="<?=base_url()?>">
                <img alt="Logo" src="<?=asset_url()?>/media/logos/logo-letter-1.png" class="logo-default max-h-30px" />
            </a>
            <!--end::Logo-->
        </div>
        <!--end::Header Mobile-->
        ...
        <div id="kt_scrolltop" class="scrolltop">
            <span class="svg-icon">
                <!--begin::Svg Icon | path:<?=asset_url()?>/media/svg/icons/Navigation/Up-2.svg-->
