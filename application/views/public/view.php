							...
							<div class="card-body pt-4">
								...
								<div class="d-flex align-items-center mt-10">
									<div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
										<div class="symbol-label" style="background-image:url('<?=upload_url()?>/<?=$talent["image"]?>')"></div>
										<i class="symbol-badge bg-success"></i>
									</div>
									<div>
										<a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary"><?=$talent["name"]?></a>
										<div class="text-muted"><?=$talent["nick_name"]?></div>
										<div class="mt-2">
								...
								<div class="py-9">
									<div class="d-flex align-items-center justify-content-between mb-2">
										...
										<a href="#" class="text-muted text-hover-primary"><?=$talent["email"]?></a>
									</div>
									<div class="d-flex align-items-center justify-content-between mb-2">
										<span class="font-weight-bold mr-2">Phone:</span>
										<span class="text-muted"><?=$talent["mobile"]?></span>
									</div>
									<div class="d-flex align-items-center justify-content-between">
										<span class="font-weight-bold mr-2">Location:</span>
										<span class="text-muted"><?=$talent["address"]?></span>
									</div>
								</div>
								<!--end::Contact-->
								<!--begin::Nav-->
